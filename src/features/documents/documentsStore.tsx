...
type DocumentsContextValue = {
  ...
  addDocument: (args: { fileName: string; type: DocumentType; ocrKind?: (import("./documentsTypes").OcrKind) | null;  caseId?: string; notes?: string; storagePath?: string }) => Promise<void>;
